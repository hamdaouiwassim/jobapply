      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5">
          	<p class="breadcrumbs mb-0"><span class="mr-3"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Offres</span> <i class="ion-ios-arrow-forward"></i></a></span> <span>Recherche</span></p>
			...
			<div class="container">
				<div class="row">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		          	<span class="subheading">Resultat de recherche</span>
             
		          </div>
		        </div>
						<div class="row">
                @if (count($offers) == 0 )
                <p>Aucun resultat pour cette recherche la, essayer de nouveaux ...</p>
                @else
