            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                      ...
                      <form action="{{ route('CondidateUpdate')}}" method='POST' class="bg-white p-1 contact-form" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                          <label> Nom  </label>
                        <input type="text" class="form-control @error('firstname') is-invalid @enderror" value="{{ auth()->user()->condidate->firstname }}"  name="firstname" >
                        @error('firstname')
                        ...
                        <div class="form-group">
                            <label> Prenom </label>
                        <input type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ auth()->user()->condidate->lastname }}" >
                            @error('lastname')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
