    		...
    		<div class="row">
    			<div class="col-md-9">
    				<div class="browse-job p-5">
                        ...
                        <hr />
                        <h2 class="mb-4">postuler pour l'offre {{ $offer->name }}</h2>
                        <p> Cette offre est ouvert jusqu'a  {{ $offer->lastday }}</p>
                        <form action="/offre/postuler" method="post">
                            @csrf
                            <input type="hidden" name="idoffer" value="{{ $offer->id }}">
                            
                            <textarea class="form-control" name="lettre" placeholder="Ecriver votre lettre de motivation ...."  cols="30" rows="10"></textarea>
                            <br />
