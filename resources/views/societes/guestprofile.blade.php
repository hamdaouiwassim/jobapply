	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              @if (Route::has('login'))
                  ...
                  @auth
                  <li class="nav-item">
                  <a class="nav-link" href="{{ url('/home') }}"><span class="icon-user"></span> {{ Auth::user()->name }} ( profile )</a>
                  </li>
                  @else
    		...
    		<div class="row">
    			<div class="col-md-12">
    				<div class="browse-job p-5">
                        <a href="/societes/all" class="btn btn-success"> Liste des societes </a>
                        <hr />
                        <h2> Profile de societe </h2>
                        <hr />
                        
                    <img src="{{ asset('/images/'.$userSociete->society->avatar)}}"  height="250" >
                    <hr />
                        <h4> Nom de la societe : <span style="color:orange"> {{ $userSociete->name }} </span>  </h4>
                        <h4> Description : </h4>
                        <p>
                            {{ $societe->description}}
                        </p>

                        <h4>Localisation : <span style="color:orange"> {{ $societe->location }} </span></h4>
